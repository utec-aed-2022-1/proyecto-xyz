...
{
    CHECK(
        to_hex_string(sha256(uint32_t{0xFFFFFFFF}))
        == "AD95131BC0B799C0B1AF477FB14FCF26A6A9F76079E48BF090ACB7E8367BFD0E");

    CHECK(
        to_hex_string(sha256(uint32_t{0xAAAAAAAA}))
        == "DBED14CEB001D110D766B9013D3B5BBFFAD6915475A9BA07932D2AC057944C04");

    CHECK(
        to_hex_string(sha256(uint32_t{0x11121314}))
        == "1AA2454E38E78FBE098BE157EE8112D85D6E667E2304FDE4220850FAA2F46341");

    CHECK(
        to_hex_string(sha256(uint64_t{0xFF}))
